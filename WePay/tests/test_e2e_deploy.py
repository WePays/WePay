...
class E2ETestDeploy(LiveServerTestCase):
    ...
    def test_update_display(self):
        ...
        self.browser.find_element(
            By.XPATH, "/html/body/div[1]/div/a[1]").click()  # click userprofile
        ...
        self.browser.find_element(
            By.XPATH, "/html/body/div[2]/div[1]/form/div/button").click()  # update userprofile
        self.assertEqual(self.browser.find_element(By.NAME, "display name").is_displayed(), True)
        self.browser.find_element(By.NAME, "display name").clear()
        self.browser.find_element(By.NAME, "display name").send_keys(
            "wepay")  # change back to Wepay
        self.browser.find_element(
            By.XPATH, "/html/body/div[2]/div[1]/form/div/button").click()  # update userprofile
        self.assertEqual(self.browser.find_element(By.NAME, "display name").is_displayed(), True)
    ...
    def test_create_bill_and_add_topic_with_deploy_web(self):
        ...
        # This button when user have bills.
        ...
        if self.browser.current_url == "https://wepays.herokuapp.com/bill/create/":
            ...
            self.browser.find_element(
                By.XPATH, "/html/body/div[2]/form/div[5]/div/div/div[1]/input").click()  # open select user
            # select three user at top
            self.browser.find_element(
                By.XPATH, "/html/body/div[2]/form/div[5]/div/div/div[2]/div/div[1]").click()
            self.browser.find_element(
                By.XPATH, "/html/body/div[2]/form/div[5]/div/div/div[2]/div/div[4]").click()
            self.browser.implicitly_wait(5)
            self.browser.find_element(By.NAME, "create_title").click()
        # This should goes to add topic page
        # But I still confused how to test with pk url.
        self.assertNotEqual(self.browser.current_url, "https://wepays.herokuapp.com/bill/create/")
        ...
        # select three user at top
        self.browser.find_element(
            By.XPATH, "/html/body/div[2]/div[2]/form/div[3]/div/div/div[2]/div/div[1]").click()
        self.browser.find_element(
            By.XPATH, "/html/body/div[2]/div[2]/form/div[3]/div/div/div[2]/div/div[4]").click()
        self.browser.find_element(By.ID, "username-ts-control").click()  # close select user
        self.browser.find_element(
            By.XPATH, "/html/body/div[2]/div[2]/form/div[4]/button").click()  # add topic
    ...
    def test_delete_button(self):
        ...
        self.browser.implicitly_wait(5)
        self.browser.find_element(
            By.XPATH, "/html/body/div[2]/div/div/table/tbody[1]/tr/td[6]/a").click()  # delete first bill
